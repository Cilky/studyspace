...
public class EndTimePickerFragment extends DialogFragment
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        EditText mEndTime = (EditText) getActivity().findViewById(R.id.new_end);
        try {
            Date date = formatter.parse(mEndTime.getText().toString());
            c.setTime(date);
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        try {
            ...
            mEndTime.setText(formatter.format(d));
        } catch (ParseException e) {
            e.printStackTrace();
        }
